...
namespace CSharpMarkup.WinUI.TableView // TableView
{
    ...
    public static partial class TableViewExtensions
    {
        ...
        public static TView AlternateRowBackground<TView>(this TView view, Xaml.Media.Brush value) where TView : TableView { view.UI.AlternateRowBackground = value; return view; }
        ...
        public static TView AlternateRowForeground<TView>(this TView view, Xaml.Media.Brush value) where TView : TableView { view.UI.AlternateRowForeground = value; return view; }
        ...
        public static TView HorizontalGridLinesStroke<TView>(this TView view, Xaml.Media.Brush value) where TView : TableView { view.UI.HorizontalGridLinesStroke = value; return view; }
        ...
        public static TView VerticalGridLinesStroke<TView>(this TView view, Xaml.Media.Brush value) where TView : TableView { view.UI.VerticalGridLinesStroke = value; return view; }
        ...
        public static DependencyProperty<TTarget, Xaml.Media.Brush> AlternateRowBackground<TTarget>(this TTarget target) where TTarget : TableView
        => DependencyProperty<TTarget, Xaml.Media.Brush>.Get(target, TvUI.TableView.AlternateRowBackgroundProperty);

        /// <summary>Bind (or set enum value of) <see cref="TvUI.TableView.AlternateRowForeground"/></summary>
        public static DependencyProperty<TTarget, Xaml.Media.Brush> AlternateRowForeground<TTarget>(this TTarget target) where TTarget : TableView
        => DependencyProperty<TTarget, Xaml.Media.Brush>.Get(target, TvUI.TableView.AlternateRowForegroundProperty);
        ...
        public static DependencyProperty<TTarget, Xaml.Media.Brush> HorizontalGridLinesStroke<TTarget>(this TTarget target) where TTarget : TableView
        => DependencyProperty<TTarget, Xaml.Media.Brush>.Get(target, TvUI.TableView.HorizontalGridLinesStrokeProperty);
        ...
        public static DependencyProperty<TTarget, Xaml.Media.Brush> VerticalGridLinesStroke<TTarget>(this TTarget target) where TTarget : TableView
        => DependencyProperty<TTarget, Xaml.Media.Brush>.Get(target, TvUI.TableView.VerticalGridLinesStrokeProperty);
...
namespace CSharpMarkup.WinUI.TableView // TableViewColumn
{
    ...
    public static partial class TableViewColumnExtensions
    {
        ...
        public static TView Width<TView>(this TView view, Xaml.GridLength value) where TView : TableViewColumn { view.UI.Width = value; return view; }
        ...
        public static DependencyProperty<TTarget, Xaml.GridLength> Width<TTarget>(this TTarget target) where TTarget : TableViewColumn
        => DependencyProperty<TTarget, Xaml.GridLength>.Get(target, TvUI.TableViewColumn.WidthProperty);
    }
}
