...
using VM = WinUICsMarkupExamples.Views.SearchViewModel;
...
{
    public void BuildUI() => this.Content(Grid(
        Rows(Auto, Star, Auto),
    ...
    void Format(Controls.TextBlock textBlock, Tweet? tweet)
    {
    ...
    static TextBlock Footer => TextBlock("See ", Link("C# Markup on GitHub", Constants.CsMarkupUri), " for more information")
