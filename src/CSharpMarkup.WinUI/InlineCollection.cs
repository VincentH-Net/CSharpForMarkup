...
namespace CSharpMarkup.WinUI
{
    ...
    {
        public static void Add(this Microsoft.UI.Xaml.Documents.InlineCollection inlines, InlineCollectionItem item)
        {
    ...
    public class InlineCollectionItem : OneOf<string, Microsoft.UI.Xaml.Documents.Inline, Microsoft.UI.Xaml.UIElement>
    {
        ...
        InlineCollectionItem(Microsoft.UI.Xaml.Documents.Inline value) : base(value) { }
        InlineCollectionItem(Microsoft.UI.Xaml.UIElement value) : base(value) { }
    }
