...
namespace _MarkupNamespace_
{
    ...
    using _ViewBaseTypeName_ = Microsoft.UI.Markup.FrameworkElement; // This is to get the template compiling; _ViewBaseTypeName_ is defined in the _UIViewNamespace_
    ...
    public static partial class Helpers
    {
        ...
        public static LayoutView LayoutView(
            ...
            Microsoft.UI.Markup.Helpers.SpreadChildren(ui.Children);
            #endregion
        ...
        )
        {
            ...
            Microsoft.UI.Markup.Helpers.SpreadInlines(ui.Inlines);
            #endregion
