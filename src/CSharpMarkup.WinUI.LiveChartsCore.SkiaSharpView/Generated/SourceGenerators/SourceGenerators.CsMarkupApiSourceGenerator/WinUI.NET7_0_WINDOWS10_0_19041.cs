...
namespace CSharpMarkup.WinUI.LiveChartsCore.SkiaSharpView // MotionCanvas
{
    public static partial class Helpers
    {
        ...
        /// <summary>Create a <see cref="LiveChartsSkiaWinUI.MotionCanvas"/></summary>
        public static MotionCanvas MotionCanvas(double? MaxFps = default, List<LiveCharts.Kernel.PaintSchedule<LiveChartsSkiaSharpView.Drawing.SkiaSharpDrawingContext>> PaintTasks = default, Xaml.UIElement Content = default)
        {
            var ui = new LiveChartsSkiaWinUI.MotionCanvas();
