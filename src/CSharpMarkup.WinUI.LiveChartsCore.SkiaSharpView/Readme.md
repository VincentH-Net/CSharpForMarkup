[C# Markup 2](https://github.com/VincentH-Net/CSharpForMarkup) API for [LiveChartsCore.SkiaSharpView.Uno](https://www.nuget.org/packages/LiveChartsCore.SkiaSharpView.Uno) NuGet
...
This release targets WinUI 3 (Windows App SDK) and Uno Platform - including browser webassembly - with C# 14 and .NET 10.
