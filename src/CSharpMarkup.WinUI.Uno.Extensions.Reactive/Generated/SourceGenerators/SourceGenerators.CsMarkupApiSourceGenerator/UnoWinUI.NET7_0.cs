...
namespace CSharpMarkup.WinUI.Uno.Extensions.Reactive // FeedView
{
    public static partial class Helpers
    {
        ...
        /// <summary>Create a <see cref="UnoExtensionsReactive.UI.FeedView"/></summary>
        public static FeedView FeedView(object? Source = default, UnoExtensionsReactive.UI.FeedViewVisualStateSelector? VisualStateSelector = default, object? Undefined = default, Xaml.DataTemplate? UndefinedTemplate = default, object? None = default, Xaml.DataTemplate? NoneTemplate = default, Xaml.DataTemplate ProgressTemplate = default, Xaml.DataTemplate ErrorTemplate = default, UnoExtensionsReactive.UI.FeedViewRefreshState? RefreshingState = default, Xaml.DataTemplate? ValueTemplate = default)
        {
            var ui = new UnoExtensionsReactive.UI.FeedView();
