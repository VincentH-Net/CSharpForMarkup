...
namespace CSharpForMarkupExample.ViewModels
{
    ...
    {
        readonly App app;
        ICommand addGroupCommand, removeGroupCommand, removeItemCommand, returnToPreviousViewCommand;
    ...
    public class ListGroup : ObservableCollection<ListItem>
    {
        ...
        public ListGroup() { Items.Add(new ListItem { IsDummy = true }); } // Dummy item is workaround for multiple Xamarin Forms bugs with empty groups / nested lists
